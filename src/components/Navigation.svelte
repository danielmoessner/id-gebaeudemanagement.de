...
<nav class="sticky top-0 outline-none z-40">
    <CustomContainer customClass="bg-indigo-500 relative">
        ...
        <div class="absolute bg-indigo-600 bottom-0 left-0 w-full h-800 transform origin-bottom-left -rotate-75 z-0">
        </div>
        <div class="absolute bg-indigo-600 bottom-0 right-0 w-full h-800 transform origin-bottom-right rotate-75 z-0">
        </div>
