...
<div class="relative overflow-hidden">
    <CustomContainer customClass="relative bg-indigo-500 z-50">
        <div class="border-b border-gray-400 py-2 flex relative z-10 ">
            <a class="text-gray-300 flex items-center hover:text-white cursor-pointer" href="tel:00491712198934">
                <svg viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5 mr-2">
                    <path
                        d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z">
                    </path>
                </svg>
                <span class="block">0171 2198934</span>
            </a>
            <a class="text-gray-300 flex items-center hover:text-white cursor-pointer ml-auto"
                href="mailto:kontakt@id-gebaeudemanagement.de?subject=Anfrage">
                <svg viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5 mr-2">
        ...
        <div class="absolute bg-indigo-400 bottom-0 right-0 w-full h-800 transform origin-bottom-right rotate-75 z-0"
            style="--transform-translate-y: 80px">
        </div>
        <div class="absolute bg-indigo-400 bottom-0 left-0 w-full h-800 transform origin-bottom-left -rotate-75 z-0"
            style="--transform-translate-y: 80px">
        </div>
