...
<div class="pt-64 pb-32 bg-gray-200">
    <CustomContainer>
        <HeaderHeading heading="Impressum" />
    </CustomContainer>
</div>
	...
	<CustomContainer>
		<div class='impressum'>
			...
			<p><strong>Kontakt:</strong> <br>
				...
				E-Mail: <a href='mailto:kontakt@id-gebaeudemanagement.de'>kontakt@id-gebaeudemanagement.de</a><br></p><br><br>
