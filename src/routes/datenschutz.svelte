...
<script>
	...
	import HeaderHeading from "../components/HeaderHeading.svelte";
	cta.set(true)
</script>

<div class="pt-64 pb-32 bg-gray-200">
    <CustomContainer>
        <HeaderHeading heading="Datenschutz" />
    </CustomContainer>
</div>
...
<div class="py-32">
	<CustomContainer>
		...
		<p>Wir freuen uns sehr über Ihr Interesse an unserem Unternehmen. Datenschutz hat einen besonders hohen
			Stellenwert für die Geschäftsleitung der I.D. Gebäudemangament. Eine Nutzung der Internetseiten der I.D.
			Gebäudemangament ist grundsätzlich ohne jede Angabe personenbezogener Daten möglich. Sofern eine betroffene
		...
		<p>Die Verarbeitung personenbezogener Daten, beispielsweise des Namens, der Anschrift, E-Mail-Adresse oder
			...
			Übereinstimmung mit den für die I.D. Gebäudemangament geltenden landesspezifischen Datenschutzbestimmungen.
		...
		<p>Die I.D. Gebäudemangament hat als für die Verarbeitung Verantwortlicher zahlreiche technische und
		...
		<p>Die Datenschutzerklärung der I.D. Gebäudemangament beruht auf den Begrifflichkeiten, die durch den
		...
		<p>I.D. Gebäudemangament</p>
		<p>Silcherstraße 13</p>
		<p>80807 München</p>
		<p>Deutschland</p>
		<p>Tel.: 0171 2198934</p>
		<p>E-Mail: kontakt@id-gebaeudemanagement.de</p>
		<p>Website: id-gebaeudemanagement.de</p>

		<h4>3. Erfassung von allgemeinen Daten und Informationen</h4>
		<p>Die Internetseite der I.D. Gebäudemangament erfasst mit jedem Aufruf der Internetseite durch eine betroffene
		...
		<p>Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die I.D. Gebäudemangament keine Rückschlüsse
			...
			Daten und Informationen werden durch die I.D. Gebäudemangament daher einerseits statistisch und ferner mit
		...
		<p>Die Internetseite der I.D. Gebäudemangament enthält aufgrund von gesetzlichen Vorschriften Angaben, die eine
		...
		<ul style="list-style: none;">
			...
			<li>
				...
				<ul style="list-style: none;">
					...
					<li>Die betroffene Person legt gemäß Art. 21 Abs. 1 DS-GVO Widerspruch gegen die Verarbeitung ein,
						...
						betroffene Person legt gemäß Art. 21 Abs. 2 DS-GVO Widerspruch gegen die Verarbeitung ein.</li>
				...
				<p>Sofern einer der oben genannten Gründe zutrifft und eine betroffene Person die Löschung von
					personenbezogenen Daten, die bei der I.D. Gebäudemangament gespeichert sind, veranlassen möchte,
					kann sie sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung Verantwortlichen
					wenden. Der Mitarbeiter der I.D. Gebäudemangament wird veranlassen, dass dem Löschverlangen
					unverzüglich nachgekommen wird.</p>

				<p>Wurden die personenbezogenen Daten von der I.D. Gebäudemangament öffentlich gemacht und ist unser
					Unternehmen als Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der personenbezogenen
					Daten verpflichtet, so trifft die I.D. Gebäudemangament unter Berücksichtigung der verfügbaren
					...
					Verarbeitung nicht erforderlich ist. Der Mitarbeiter der I.D. Gebäudemangament wird im Einzelfall
			...
			<li>
				...
				<p>Sofern eine der oben genannten Voraussetzungen gegeben ist und eine betroffene Person die
					Einschränkung von personenbezogenen Daten, die bei der I.D. Gebäudemangament gespeichert sind,
					verlangen möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
					Verantwortlichen wenden. Der Mitarbeiter der I.D. Gebäudemangament wird die Einschränkung der
			...
			<li>
				...
				<p>Zur Geltendmachung des Rechts auf Datenübertragbarkeit kann sich die betroffene Person jederzeit an
					einen Mitarbeiter der I.D. Gebäudemangament wenden.</p>
			...
			<li>
				...
				<p>Die I.D. Gebäudemangament verarbeitet die personenbezogenen Daten im Falle des Widerspruchs nicht
				...
				<p>Verarbeitet die I.D. Gebäudemangament personenbezogene Daten, um Direktwerbung zu betreiben, so hat
					...
					solcher Direktwerbung in Verbindung steht. Widerspricht die betroffene Person gegenüber der I.D.
					Gebäudemangament der Verarbeitung für Zwecke der Direktwerbung, so wird die I.D. Gebäudemangament
				...
				<p>Zudem hat die betroffene Person das Recht, aus Gründen, die sich aus ihrer besonderen Situation
					ergeben, gegen die sie betreffende Verarbeitung personenbezogener Daten, die bei der I.D.
					Gebäudemangament zu wissenschaftlichen oder historischen Forschungszwecken oder zu statistischen
				...
				<p>Zur Ausübung des Rechts auf Widerspruch kann sich die betroffene Person direkt an jeden Mitarbeiter
					der I.D. Gebäudemangament oder einen anderen Mitarbeiter wenden. Der betroffenen Person steht es
			...
			<li>
				...
				<p>Ist die Entscheidung (1) für den Abschluss oder die Erfüllung eines Vertrags zwischen der betroffenen
					...
					der betroffenen Person, trifft die I.D. Gebäudemangament angemessene Maßnahmen, um die Rechte und
		...
		<p>Diese Datenschutzerklärung wurde durch den Datenschutzerklärungs-Generator der DGD Deutsche Gesellschaft für
			Datenschutz GmbH, die als <a
				...
				rel="nofollow">Externer Datenschutzbeauftragter Memmingen</a> tätig ist, in Kooperation mit dem <a
				href="https://www.wbs-law.de/it-recht/datenschutzrecht" rel="nofollow">Anwalt für Datenschutzrecht</a>
